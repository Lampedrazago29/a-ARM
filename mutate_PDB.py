...
def Scwrl4_mutations(mut_pdbARM):
    ...
    for i in range(0,len(mutation_seqmut)):
        ...
        os.system(scrl4Script+" -i "+mut_pdbARM+" -o "+mutation_output+" -h -t -f "+pdbHETATM+" -s "+seqFileName+" > scwrl4_mut."+str(mutation_seqmut[i])+".log" )                                                                                                      
#        os.system(scrl4Script+" -i "+mut_pdbARM+" -o "+mutation_output+" -h -s "+seqFileName+" > scwrl4_mut."+str(mutation_seqmut[i])+".log" )
        print( (scrl4Script+" -i "+mut_pdbARM+" -o "+mutation_output+" -h -f "+pdbHETATM+" -s "+seqFileName+" > scwrl4_mut."+str(mutation_seqmut[i])+".log" ))
...
#This step ask the user for the list of mutations. Similar to the seqmut file                                                                                                                                       
    ...
    if mutation_SoftwareName == "Modeller":
        print("We suggest you to use Scwrl4")
        mutation_SoftwareName == "Scwrl4"
# #SCWRL4 routine                                                                                                                                                                                               
